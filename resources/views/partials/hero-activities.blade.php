...
<section class="relative pt-32 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=2000&q=80" alt="Activities Background" class="w-full h-full object-cover"/>
    ...
    <div class="max-w-7xl mx-auto relative z-10 text-center">
        <div class="animate-fade-in-up">
            ...
            <p class="text-lg text-white/80 max-w-2xl mx-auto">
                Explore our laboratory activities, workshops, competitions, and events throughout the years
            </p>
        </div>
    </div>
</section>
