...
<nav class="sticky top-0 z-[90] bg-white shadow-sm border-b border-border">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center gap-3">
                    <div class="relative group">
                        <img src="https://avatars.githubusercontent.com/u/63681676?s=280&v=4" alt="Polinema Logo" class="w-12 h-12 object-contain hover:scale-105 transition-transform"/>
                    </div>
                    <div class="relative group">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Jti_polinema.svg/328px-Jti_polinema.svg.png?20240606144137" alt="JTI Logo" class="w-12 h-12 object-contain hover:scale-105 transition-transform"/>
                    </div>
                </div>
                <div class="hidden lg:block border-l-2 border-primary/30 pl-4">
                    <p class="text-lg font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent leading-tight">Network & Cyber Security Lab</p>
                    <p class="text-xs text-muted-foreground leading-tight">Politeknik Negeri Malang</p>
                </div>
            </div>
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="mobile-menu fixed top-0 right-0 w-80 h-full bg-white shadow-2xl z-[98] md:hidden overflow-y-auto">
        <!-- Mobile Menu Header -->
        <div class="sticky top-0 bg-gradient-to-r from-primary to-secondary p-4 flex items-center justify-between border-b border-white/20">
            <div class="flex items-center gap-2">
                <div class="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                    <img src="https://avatars.githubusercontent.com/u/63681676?s=280&v=4" alt="Logo" class="w-8 h-8 rounded-full"/>
                </div>
                <div>
                    <h3 class="text-white font-bold text-sm">NCS Lab</h3>
                    <p class="text-white/80 text-xs">Menu</p>
                </div>
            </div>
        ...
        <div class="p-4 space-y-2">
            <!-- Home -->
            <a href="/" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-muted/50 hover:bg-primary/10 hover:text-primary transition-all group">
            ...
            <!-- Profile Section -->
            <div class="space-y-1">
                <div class="flex items-center gap-2 px-4 py-2 text-xs font-bold text-muted-foreground uppercase tracking-wider">
                ...
                <div class="space-y-1 pl-2">
                    <a href="/vision-mission" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Vision & Mission
                    </a>
                    <a href="/profile" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Laboratory Profile
                    </a>
                    <a href="/logo" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Logo
                    </a>
                    <a href="/organization" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
            ...
            <div class="space-y-1">
                ...
                <div class="space-y-1 pl-2">
                    <a href="/agenda" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Agenda
                    </a>
                    <a href="/activities" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Past Activities
                    </a>
                </div>
            ...
            <div class="space-y-1">
                ...
                <div class="space-y-1 pl-2">
                    <a href="/research-documents" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Research Documents
                    </a>
                    <a href="/community-service" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Community Service
                    </a>
                </div>
            ...
            <div class="space-y-1">
                ...
                <div class="space-y-1 pl-2">
                    <a href="/infrastructure" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Infrastructure & Facilities
                    </a>
                    <a href="/consulting" class="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-primary/10 hover:text-primary transition-all text-sm">
                        <div class="w-1.5 h-1.5 rounded-full bg-primary"></div>
                        Consulting Services
                    </a>
                </div>
            ...
            <!-- Links -->
            <a href="/links" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-muted/50 hover:bg-primary/10 hover:text-primary transition-all group">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-primary">
        ...
        <!-- Mobile Menu Footer -->
        <div class="sticky bottom-0 bg-gradient-to-r from-slate-900 to-indigo-950 p-4 mt-4">
            <div class="text-center">
                <p class="text-white/60 text-xs">Network & Cyber Security Lab</p>
                <p class="text-white/80 text-xs font-semibold">Politeknik Negeri Malang</p>
            </div>
        </div>
    </div>
</nav>
